...
<html lang="en">
  <head>
    <title>Feedback &mdash; Enchanted Elegance</title>
    <meta charset="utf-8">
          ...
          <div class="col-10 col-md-8 d-none d-xl-block" data-aos="fade-down">
            <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="active"><a id="feedbackLink">FeedBack</a></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mt-2 mb-5">
            <form id="feedbackForm" action="../../add-feedback" method="post" class="p-5 bg-white">
              <h2 class="mb-4 site-section-heading">FeedBack</h2>
              
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  <label class="text-black required" for="name">Name</label>
                  <input type="text" id="name" name="name" class="form-control" value="<%= user.getName() %>" placeholder="Your Name" readonly>
                </div>
                <div class="col-md-6">
                  <label class="text-black required" for="email">Email</label> 
                  <input type="text" id="email" name="email" class="form-control" value="<%= user.getEmail() %>" placeholder="Your Email" readonly>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="text" id="mobile" name="mobile" class="form-control" value="<%= user.getMobile() %>" placeholder="Phone Number" readonly>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="5" class="form-control" placeholder="Write your feedback here..." ></textarea>
  ...
  <script src="/enchanted_elegance/pages/customer/js/components/feedback.js"></script>
