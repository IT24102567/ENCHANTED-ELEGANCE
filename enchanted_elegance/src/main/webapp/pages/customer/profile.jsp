        ...
        <div class="row">
          <div class="col-md-7 mt-3 mb-5">
            <div class="p-5 bg-white">
                <h2 class="mb-4 site-section-heading">Profile</h2>
                
                <div class="row">
                    <div class="col-md-12 mb-3 mb-md-0">
                        <label class="text-black" for="name">Name :</label>
                            <p class="mb-4"> <%= user.getName() %></p>                        
                    </div>                   
                </div>
                <div class="row">
                    <div class="col-md-12 mb-3 mb-md-0">
                        <label class="text-black" for="mobile">Mobile :</label>
                            <p class="mb-4"> <%= user.getMobile() %></p>                        
                    </div>                   
                </div>                
                <div class="row">
                    <div class="col-md-12 mb-3 mb-md-0">
            ...
            <div class="row">
                    <% if (session.getAttribute("user") != null) { %>
                        <div class="col-md-6 mb-3 mb-md-0">
                            <p><a href="/enchanted_elegance/pages/customer/edit-profile.jsp" class="btn btn-primary px-4 py-2 text-white col-md-12"><i class="fa fa-pencil mr-1"></i>Edit</a></p>                   
                        </div>
                    <% } %>
                    <% if (session.getAttribute("user") != null) { %>
                    <div class="col-md-6 mb-3 mb-md-0">
