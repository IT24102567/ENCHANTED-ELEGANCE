...
<head>
  <title>About &mdash; Enchanted Elegance</title>
  <meta charset="utf-8">
  ...
  <div class="site-wrap">
          ...
          <div class="col-10 col-md-8 d-none d-xl-block" data-aos="fade-down">
            <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="active"><a id="aboutLink">About</a></li>
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover inner-page-cover"
        style="background-image: url(/enchanted_elegance/pages/customer/images/hero_bg_2.jpg);" data-aos="fade"
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="/enchanted_elegance/pages/customer/images/person_1.jpg" alt="Image"
            ...
            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur ab quas facilis obcaecati
              non ea, est odit repellat distinctio incidunt, quia aliquam eveniet quod deleniti impedit sapiente atque
              tenetur porro?</p>
            <p>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="/enchanted_elegance/pages/customer/images/person_2.jpg" alt="Image"
              class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="/enchanted_elegance/pages/customer/images/person_4.jpg" alt="Image"
              class="img-fluid w-50 rounded-circle mb-4">
