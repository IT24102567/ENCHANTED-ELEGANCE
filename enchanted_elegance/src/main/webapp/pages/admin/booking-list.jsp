...
<head>
  ...
  <title>Booking List &mdash; Enchanted Elegance</title>
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link active" href="/enchanted_elegance/admin/booking-list" aria-expanded="false">
                <span>
                      ...
                      <div class="card-body">
                          <div class="d-sm-flex d-block align-items-center justify-content-between mb-3 mb-lg-4">
                              <div class="mb-2 mb-sm-0">
                                  <h5 class="card-title fw-semibold mb-0">Booking List</h5>
                              </div>
                          </div>
                            ...
                            <div class="ad-taade-container">
                                <table class="ad-taade table table-hover mb-0">
                                    <thead class="ad-thead">
                                        <tr>
                                            <th class="ad-th text-nowrap">User ID</th>
                                            <th class="ad-th text-nowrap">Name</th>
                                            <th class="ad-th text-nowrap">Mobile</th>
                                            <th class="ad-th text-nowrap">Email</th>
                                            <th class="ad-th text-nowrap">Treatment</th>
                                            <th class="ad-th text-nowrap">Booking Date</th>
                                            <th class="ad-th text-nowrap">Note</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            <td class="ad-td fs-sm"><%= booking.getUserId() %></td>
                                            <td class="ad-td fs-sm text-nowrap"><%= booking.getName() %></td>
                                            <td class="ad-td fs-sm"><%= booking.getMobile() %></td>
                                            <td class="ad-td fs-sm"><%= booking.getEmail() %></td>
                                            <td class="ad-td fs-sm"><%= booking.getTreatment() %></td>
                                            <td class="ad-td fs-sm"><%= booking.getDate() %></td>
                                            <td class="ad-td fs-sm text-truncate"><%= booking.getNote() %></td>
                                        ...
                                        %>
                                        <tr>
                                            <td colspan="9" class="text-center py-4 fs-sm">No bookings found.</td>
                                        </tr>
                                        <% } %>
                                    </tbody>
                                </table>
