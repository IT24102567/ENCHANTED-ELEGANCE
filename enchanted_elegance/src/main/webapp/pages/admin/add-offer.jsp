...
<head>
  ...
  <title>Add Offer &mdash; Enchanted Elegance</title>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body p-4 p-md-5">
                <h2 class="mb-3 mb-md-3">Add New Offer</h2>
                <form id="offerForm" class="w-100" action="/enchanted_elegance/admin/add-offer" method="post">
                    <input type="hidden" name="page" value="<%= pageNo %>">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control form-control-lg" id="titleInput" placeholder="Title" name="title">
                        ...
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="text" class="form-control form-control-lg" id="discountInput" placeholder="Discount" name="discount">
                        ...
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="text" class="form-control form-control-lg" id="imageUrlInput" placeholder="Image URL" name="imageUrl" oninput="loadImagePreview()">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control form-control-lg" id="descriptionInput" placeholder="Description" name="description" style="height: 120px"></textarea>
                        ...
                        <div class="mt-3">
                            ...
                            <a href="/enchanted_elegance/admin/offer-list?page=<%= pageNo %>" class="btn btn-outline-primary py-2 rounded-2 ms-2">
                                Back to Offer List
                            </a>
                        </div>
                    </div>
