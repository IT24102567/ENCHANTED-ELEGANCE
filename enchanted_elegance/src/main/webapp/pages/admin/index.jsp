...
<%
    Admin admin = (Admin) session.getAttribute("admin");
      if (admin == null) {
            response.sendRedirect("/enchanted_elegance/pages/admin/login.jsp"); // Redirect to the login page if not logged in
            return;
        }
%>
...
<head>
  ...
  <title>Dashboard &mdash; Enchanted Elegance</title>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link active" href="/enchanted_elegance/pages/admin/index.jsp" aria-expanded="false">
                <span>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              ...
              <div class="card-body pt-3 p-4">
                <h6 class="fw-semibold fs-4">Test Data Product</h6>
